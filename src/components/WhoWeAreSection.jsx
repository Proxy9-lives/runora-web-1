...
const ProblemSection = ({ id }) => (
  <div id={id} className="section who-we-are">
    <div className="wwa-content">
      ...
      <h2 className="wwa-title">WHY BUSINESSES STRUGGLE</h2>
      <div className="problem-grid">
        <ProblemCard title="Missed calls & delayed replies" consequence="Lost revenue" />
        <ProblemCard title="Repetitive admin work" consequence="Wasted payroll" />
        <ProblemCard title="Disconnected systems" consequence="Errors & delays" />
      </div>
      <p className="problem-subtitle">
        Businesses don't fail due to lack of tools. They fail due to slow responses, manual ops, and execution constraints.
      </p>
    </div>
  </div>
);
